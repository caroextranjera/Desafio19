			...
			<div class="gtco-container">
				<div class="row gtco-heading">
					<div class="col-md-7 text-left">
						...
						<p>Vidrios sellados de la más alta calidad.
                           Los colocamos en donde tú estés.
                           Fabricadas con los mejores procesos de producción.</p>
					</div>
				...
				<div class="row">
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="feature-left">
							...
							<div class="copy">
								<h3>Guardados en nuestras bodegas especializadas</h3>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="feature-left">
							...
							<div class="copy">
								<h3>Seguros en nuestros packagings de la más alta tecnología</h3>
								<p>Lorem ipsum dolor sit ameteista, consectetur adipiscing is not elitistaris.</p>
								<p><a href="#" class="gtco-more">Learn more</a></p>
							</div>
						</div>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="feature-left">
							...
							<div class="copy">
								<h3>Pulidos de manera atomizada</h3>
								<p>Lorem ipsum dolor sit ameteista, consectetur adipiscing is not elitistaris.</p>
								<p><a href="#" class="gtco-more">Learn more</a></p>
							</div>
						</div>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="feature-left">
							...
							<div class="copy">
								<h3>Perfectos para ser incorporados a todo tipo de superficies</h3>
								<p>Lorem ipsum dolor sit ameteista, consectetur adipiscing is not elitistaris.</p>
								<p><a href="#" class="gtco-more">Learn more</a></p>
							</div>
						</div>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="feature-left">
							...
							<div class="copy">
								<h3>Con una garantía de por vida</h3>
								<p>Lorem ipsum dolor sit ameteista, consectetur adipiscing is not elitistaris.</p>
								<p><a href="#" class="gtco-more">Learn more</a></p>
							</div>
						</div>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="feature-left">
							...
							<div class="copy">
								<h3>Utilizamos energías renovables.</h3>
								<p>Lorem ipsum dolor sit ameteista, consectetur adipiscing is not elitistaris.</p>
								<p><a href="#" class="gtco-more">Learn more</a></p>
							</div>
						</div>
